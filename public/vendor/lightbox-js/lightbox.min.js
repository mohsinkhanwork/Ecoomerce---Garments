    ...
    var s = void 0,
        ...
        r = function (e) {
            if ("A" === o.tagName && (e = e.getAttribute("href")), e.match(/\.(jpeg|jpg|gif|png)/)) {
                ...
                return t.className = "lightbox-image", t.src = e, "A" === o.tagName && (t.alt = o.getAttribute("data-image-alt")), t
            }
            if (e.match(/(youtube|vimeo)/)) {
                var a = [];
                return e.match("youtube") && (a.id = e.split(/v\/|v=|youtu\.be\//)[1].split(/[?&]/)[0], a.url = "youtube.com/embed/", a.options = "?autoplay=1&rel=0"), e.match("vimeo") && (a.id = e.split(/video\/|https:\/\/vimeo\.com\//)[1].split(/[?&]/)[0], a.url = "player.vimeo.com/video/", a.options = "?autoplay=1title=0&byline=0&portrait=0"), a.player = m.createElement("iframe"), a.player.setAttribute("allowfullscreen", ""), a.player.setAttribute("webkitallowfullscreen", ""), a.player.setAttribute("mozallowfullscreen", ""), a.player.setAttribute("frameborder", "0"), a.player.className = "lightbox-video-player", a.player.src = "https://" + a.url + a.id + a.options, a.wrapper = m.createElement("div"), a.wrapper.className = "lightbox-video-wrapper", a.wrapper.appendChild(a.player), a.wrapper
            }
        ...
        h = function (e) {
            ...
            for (var a in t) {
                if (t[a] !== null) {
                    t[a] = t[a].querySelector('[data-lightbox]');
                } else {
                    var nodes = m.querySelectorAll('[data-lightbox="' + e.dataset.lightbox+'"]');
                    var first = nodes[0];
        ...
        x = function (e) {
            ...
            var t = h(u)[e];
            if (null !== t)
                for (var a in i.style.animation = v, setTimeout(function () {
                    i.replaceChild(r(t), i.children[0]), i.style.animation = l
                }, 200), u.classList.remove(g), t.classList.add(g), u = t, c) c.hasOwnProperty(a) && (c[a].disabled = !h(t)[a])
        },
        E = function (e) {
            var t = e.target,
                a = e.keyCode,
                i = e.type;
            (("click" == i && -1 !== [d, s].indexOf(t) || "keyup" == i && 27 == a) && d.parentElement === o.parentElement && (N("remove"), d.style.animation = v, p.style.animation = [f, v], setTimeout(function () {
                if (y(), o.parentNode.removeChild(d), "A" === o.tagName) {
                    u.classList.remove(g);
                    var e = m.querySelector("." + b);
                    e.classList.remove(b), e.focus()
                }
            }, 200)), c) && (("click" == i && t == c.next || "keyup" == i && 39 == a) && x("next"), ("click" == i && t == c.previous || "keyup" == i && 37 == a) && x("previous"));
            if ("keydown" == i && 9 == a) {
                ...
                var n = (l = d.querySelectorAll(l.toString()))[0],
                    r = l[l.length - 1];
                e.shiftKey ? m.activeElement == n && (r.focus(), e.preventDefault()) : (m.activeElement == r && (n.focus(), e.preventDefault()), r.addEventListener("blur", function () {
