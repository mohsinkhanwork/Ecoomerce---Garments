...
class BlogPost extends \WebDevEtc\BlogEtc\Models\BlogEtcPost
{
    use Sluggable;
    use Indexable;
    ...
    {
        return $this->belongsToMany(BlogCategory::class, 'blog_etc_post_categories', 'blog_etc_post_id', 'blog_etc_category_id');
    }
    ...
    {
        return $this->hasMany(\WebDevEtc\BlogEtc\Models\BlogEtcComment::class, 'blog_etc_post_id');
    }
