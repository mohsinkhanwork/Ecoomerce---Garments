...
return [
    ...
    'blog_prefix' => "fashion-blog", // used in routes.php. If you want to your http://yoursite.com/latest-news (or anything else), then enter that here. Default: blog
    ...
    'image_quality' => 90, // what image quality to use when saving images. higher = better + bigger sizes. Around 80 is normal.
