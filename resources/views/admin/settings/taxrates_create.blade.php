...
<div class="main-content">
    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            |‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒
            !-->
            <form class="card" method="post" action="{{ url('/dashboard/settings/taxrates/store') }}">
                @csrf
                ...
                <div class="card-body">
                            ...
                            <select type="text" class="form-control" id="taxrate_country" name="country_id" required>
                                ...
                                @if( $countries )
                                    @foreach ( $countries as  $country )
                                        <option value="{{ $country->id }}" {{ $country->id == 231 ? 'selected="selected"' : ''}}> {{ $country->name }} </option>
                                    @endforeach
                                @endif
                            </select>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <select type="text" class="form-control" id="taxrate_state" name="state_id" disabled required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <div class="input-group">
                                <input type="number" name="rate" id="taxrate_rate" class="form-control text-right" min="0" step="0.01" value="{{ old( 'rate' ) }}" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <label for="taxrate_status_active" style="margin-right: 20px;">
                                <input type="radio" name="status" id="taxrate_status_active" value="1" checked>
                                <span style="margin-left: 5px;">Active</span>
                            </label>
                            <label for="taxrate_status_inactive">
                                <input type="radio" name="status" id="taxrate_status_inactive" value="0">
                ...
                <div class="card-footer text-right">
                    ...
                    <input type="submit" class="btn btn-primary" value="Add Rate">
                </div>
            </form>
        </div>
    </div>
...
;(function($){
    $(window).on('load', function(){
        ...
        getStateByCountryId( $, token, 231 );
        $('#taxrate_country').on('change', function(){
            getStateByCountryId( $, token, $(this).val() );
        });
    });

    function getStateByCountryId( $, token, country_id ) {
        $.ajax({
            type: "GET",
