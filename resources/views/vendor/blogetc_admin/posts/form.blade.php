...
<div class="form-group">
    ...
    <small class="form-text text-muted">To display post on home page right side list.</small>
</div>
<div class="form-group">
    ...
    <small class="form-text text-muted">To display post on home page Left side single post.</small>
...
<script>
    document.getElementById("is_show_to_home").value = '{{ old("is_show_to_home",$post->is_show_to_home)?old("is_show_to_home",$post->is_show_to_home):"0" }}';
    document.getElementById("is_featured").value = '{{old("is_featured",$post->is_featured)?old("is_featured",$post->is_featured):"0"}}';
</script>